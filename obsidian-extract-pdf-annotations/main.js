...
`;
      ...
      if (this.settings.sortByPageNum) {
        if (PageNumber != a.pageNumber) {
  ...
  loadSettings() {
    ...
    (() => __async(this, null, function* () {
      ...
      if (loadedSettings) {
        ...
        this.settings.sortByPageNum = loadedSettings.sortByPageNum;
      }
    }))();
  }
  onunload() {
...
var PDFAnnotationPluginSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Sort by Page Number").setDesc("If enabled, uses the notes page number for primary sorting").addToggle((toggle) => toggle.setValue(this.plugin.settings.sortByPageNum).onChange((value) => {
      this.plugin.settings.sortByPageNum = value;
      this.plugin.saveData(this.plugin.settings);
    }));
  }
};
